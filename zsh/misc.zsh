...
POWERLEVEL9K_SWIFT_VERSION_BACKGROUND="deepskyblue4"
POWERLEVEL9K_SWIFT_VERSION="white"
POWERLEVEL9K_TIME_FORMAT="%D{%H:%M} %F{003}\uF017"
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=('context' 'dir' 'vcs')
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=('node_version' 'rbenv' 'swift_version' 'ram_joined')
